package tech.getarrays.privatelessons.model;
...
public class Tutors implements Serializable {
    ...
    public Tutors(Long id, String name, String email, String jobTitle, String phone, String imageUrl, String tutorCode) {
        this.id = id;
        this.name = name;
        this.email = email;
